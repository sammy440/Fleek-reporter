...
//         {
//           sub: token.sub, // required for auth.uid()
//           email: token.email, // optional, but good to include
//           role: "authenticated", // Supabase expects role claim
//         },
...
//       const targetPath = url.startsWith(baseUrl)
//         ? url.slice(baseUrl.length)
//         : url;

//       // Default to /account if no callback URL or homepage is passed
...
//   },
//   pages: {
//     signIn: "/", // still shows modal on homepage
